...
package com.example.mealmenu.ui.planner
...
import com.example.mealmenu.MainActivity.Companion.calendar

import com.example.mealmenu.ui.adapter.MenuItemAdapter
import com.example.mealmenu.ui.customdialog.Add4mTemplateDialog
import com.example.mealmenu.ui.customdialog.AddDishesDialog
import com.example.mealmenu.ui.customdialog.AddItemsDialog
import com.example.mealmenu.ui.customdialog.EditItemsDialog
import com.example.mealmenu.ui.database.MenuItemList
import com.example.mealmenu.ui.database.TemplateList
import com.example.mealmenu.ui.viewmodel.GenericViewModel
import com.example.mealmenu.R
import com.example.mealmenu.databinding.FragmentPlannerBinding
import com.example.mealmenu.databinding.MenulayoutBinding
...
class PlannerFragment : Fragment(), EditItemsDialog.OnEditItemSelectedListener, AddItemsDialog.OnItemSelectedListener,
    AddDishesDialog.OnTemplateSelectedListener, Add4mTemplateDialog.On4mTemplateSelectedListener {
    ...
    override fun on4mTemplateSelected(template: String) {
        ...
        lifecycleScope.launch {
            ...
            Log.d("menuItemList",menuItemList.toString())
            var recordcount =viewModel.getLatestMenuId()
            for (menuItem in menuItemList) {
                val i=viewsTexts.indexOf(menuItem.dayString)
                val menuValue = MenuItemList(id=recordcount+1,mealType = menuItem.mealType, itemName =menuItem.itemName.replaceFirstChar(Char::uppercase), dateString =datevalue[i], dayString = menuItem.dayString )
                Log.d("menuValue",menuValue.toString())
